...
urlpatterns = [
    ...
    # url(r'^encuestas/preguntas/categoria/(?P<pk>\d+)/$', views.CategoriaPreguntaDetailView.as_view(), name='categoria_pregunta_detail'),
    # url(r'^encuestas/preguntas/categoria/(?P<pk>\d+)/actualizar/$', views.CategoriaPreguntaUpdateView.as_view(), name='categoria_pregunta_update'),
