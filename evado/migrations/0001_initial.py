    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encuestado', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255)),
                ('codigo', models.CharField(choices=[('EN0000', 'Evaluación Normal'), ('EN0001', 'Evaluación Docente'), ('EN0002', 'Evaluación Personalizada'), ('EN0003', 'Evaluación desde Superiores'), ('EN004', 'Evaluación Docente de sus cursos')], max_length=10, unique=True, verbose_name='Código')),
            ],
        ),
        migrations.CreateModel(
